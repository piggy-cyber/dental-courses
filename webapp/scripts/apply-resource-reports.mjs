// Applies supabase/resource-reports.sql
...
const sql = readFileSync(path.join(webappRoot, "supabase", "resource-reports.sql"), "utf8");

await client.connect();
try {
  await client.query(sql);
  console.log("Resource reports migration applied.");
} catch (error) {
