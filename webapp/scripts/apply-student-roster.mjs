// Applies supabase/student-roster.sql
...
const sql = readFileSync(path.join(webappRoot, "supabase", "student-roster.sql"), "utf8");

await client.connect();
try {
  await client.query(sql);
  console.log("Student roster migration applied.");
} catch (error) {
