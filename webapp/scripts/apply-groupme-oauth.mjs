// Applies supabase/groupme-oauth.sql
...
const sql = readFileSync(path.join(webappRoot, "supabase", "groupme-oauth.sql"), "utf8");

await client.connect();
try {
  await client.query(sql);
  console.log("GroupMe OAuth migration applied.");
} catch (error) {
