// Applies supabase/canvas-calendar-url.sql
...
const sql = readFileSync(path.join(webappRoot, "supabase", "canvas-calendar-url.sql"), "utf8");

await client.connect();
try {
  await client.query(sql);
  console.log("Canvas calendar URL migration applied.");
} catch (error) {
