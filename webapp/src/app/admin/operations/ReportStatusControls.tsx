      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {status !== "dismissed" && (
          <button
            ...
            disabled={isPending}
            className="rounded-full border border-brand-line px-3 py-1.5 text-xs font-semibold text-brand-muted disabled:opacity-60"
          >
            Dismiss
          </button>
        )}
        {status !== "open" && (
          <button
            ...
            onClick={() => update("open")}
            disabled={isPending}
            className="rounded-full border border-amber-200 px-3 py-1.5 text-xs font-semibold text-amber-700 disabled:opacity-60"
          >
            Reopen
          </button>
        )}
